        ...
        <div class="w-full max-w-md mx-auto relative z-10">
            <div class="glass rounded-3xl p-8">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <button type="submit"
                        class="w-full green-gradient-bg text-white font-semibold rounded-xl px-6 py-3 btn-primary mb-6">
                        Masuk
                    </button>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <a href="#"
                            class="social-btn bg-white rounded-xl px-4 py-3 flex items-center justify-center gap-2">
