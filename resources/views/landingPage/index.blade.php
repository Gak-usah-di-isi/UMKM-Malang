...
@section('content')
    <!-- Hero Section -->
    <section id="home" class="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 flex items-center relative overflow-hidden pt-16 md:pt-20">
        ...
        <div class="container max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12 relative z-10">
            <div class="grid lg:grid-cols-2 gap-6 md:gap-10 lg:gap-12 items-center">
                ...
                <div class="text-gray-800 space-y-8 order-2 lg:order-2 section-reveal">
                    <div>
                        ...
                        <h1 class="text-4xl md:text-5xl lg:text-6xl font-black leading-tight">
                            ...
                            <span class="block text-2xl md:text-3xl lg:text-4xl font-medium text-gray-600">Kota Malang</span>
                        </h1>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <button class="bg-white/60 border border-white/30 text-green-600 px-8 py-4 rounded-full font-semibold text-lg hover:bg-white/80 transition-all">
                    ...
                    <div class="grid grid-cols-3 gap-4 md:gap-6 pt-6 md:pt-8">
                        <div class="text-center">
                            <div class="text-2xl md:text-3xl font-black bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">500+</div>
                            <div class="text-gray-500 text-sm md:text-base">UMKM Terdaftar</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl md:text-3xl font-black bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">2000+</div>
                            <div class="text-gray-500 text-sm md:text-base">Produk Tersedia</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl md:text-3xl font-black bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">10K+</div>
                ...
                <div class="section-reveal order-1 lg:order-1">
                    <div class="relative">
                        <div class="w-full h-72 md:h-96 lg:h-[500px] bg-white/80 border border-white/20 rounded-3xl flex items-center justify-center">
                        ...
                        <div class="absolute -bottom-8 md:-bottom-10 -right-8 md:-right-10 w-20 md:w-32 h-20 md:h-32 bg-gradient-to-r from-amber-400 to-orange-500 rounded-full flex items-center justify-center shadow-2xl">
    ...
    <section class="py-8 md:py-12 lg:py-16 bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 relative mt-0 md:-mt-10 lg:-mt-20 mx-2 md:mx-6">
        <div class="container max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12">
            <div class="bg-white/80 border border-white/20 rounded-3xl shadow-2xl p-4 md:p-8">
                <div class="grid lg:grid-cols-4 gap-2 md:gap-4">
                    ...
                    <div>
                        <select class="appearance-none w-full px-4 md:px-6 py-3 md:py-4 rounded-2xl border border-gray-200 focus:border-green-500 focus:outline-none focus:ring-4 focus:ring-green-200 text-base md:text-lg cursor-pointer">
                    ...
                    <div>
                        <button class="w-full bg-gradient-to-r from-green-500 to-emerald-500 text-white px-4 md:px-6 py-3 md:py-4 rounded-2xl font-semibold text-base md:text-lg hover:shadow-xl transition-all">
                            <i class="fas fa-search mr-2"></i>
                            Cari
                        </button>
                    </div>
        ...
        <div class="container max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12">
            ...
            <div class="grid md:grid-cols-3 gap-4 md:gap-8">
                ...
                <div class="section-reveal group relative">
                    ...
                    <div class="bg-white/60 border border-white/30 rounded-3xl p-6 border-neutral-200 transition-all duration-500 transform hover:-translate-y-3 hover:border-green-200 cursor-pointer overflow-hidden relative shadow-xl">
        ...
        <div class="container max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12">
            <div class="text-center mb-8 md:mb-12 lg:mb-16 section-reveal">
                ...
                <div class="flex flex-wrap justify-center gap-2 md:gap-4 mb-4 md:mb-8">
                    <button id="filterNew" class="filter-btn bg-white/70 text-gray-700 border-2 border-gray-300 px-4 md:px-6 py-2 md:py-3 rounded-full font-semibold transition-all duration-300 hover:border-green-600 hover:text-green-600 active">
                        Produk Terbaru
                    </button>
                    <button id="filterFavorite" class="filter-btn bg-white/70 text-gray-700 border-2 border-gray-300 px-4 md:px-6 py-2 md:py-3 rounded-full font-semibold transition-all duration-300 hover:border-green-600 hover:text-green-600">
                        Produk Favorit
                    </button>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6" id="productGrid">
                ...
                <div class="section-reveal group product-card" data-category="baru">
                    <div class="bg-white/60 border border-white/30 rounded-2xl overflow-hidden transition-all duration-500 transform hover:-translate-y-2 hover:border-green-200 cursor-pointer shadow-lg">
    ...
    <section class="py-10 md:py-16 lg:py-20 bg-white">
        <div class="container max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
                <!-- Agenda 1 -->
                <div class="section-reveal bg-white/60 border border-white/30 rounded-3xl shadow-lg overflow-hidden border-l-4 border-green-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                    <div class="p-6">
                ...
                <!-- Agenda 2 -->
                <div class="section-reveal bg-white/60 border border-white/30 rounded-3xl shadow-lg overflow-hidden border-l-4 border-emerald-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                ...
                <!-- Agenda 3 -->
                <div class="section-reveal bg-white/60 border border-white/30 rounded-3xl shadow-lg overflow-hidden border-l-4 border-teal-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
                ...
                <!-- Agenda 4 -->
                <div class="section-reveal bg-white/60 border border-white/30 rounded-3xl shadow-lg overflow-hidden border-l-4 border-orange-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                    <div class="p-6">
                        <div class="flex items-center mb-4">
    ...
    <section id="news" class="py-10 md:py-16 lg:py-20 bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50">
         <div class="container max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12">
             ...
             <div class="grid lg:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-8 mb-8 md:mb-12">
                <!-- Article 1 -->
                 <div class="section-reveal group bg-white/60 border border-white/30 rounded-3xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
    ...
    <!-- Join UMKM Section -->
    <section class="py-10 md:py-16 lg:py-20 bg-gradient-to-br from-green-400 via-emerald-500 to-teal-600 relative overflow-hidden">
        ...
        <div class="container max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12 relative z-10">
            <div class="text-center text-white section-reveal">
                ...
                <button class="bg-white text-blue-600 px-8 md:px-12 py-4 rounded-full font-bold text-lg md:text-xl hover:bg-blue-50 transition-all transform hover:scale-105">
                ...
                <div class="section-reveal">
                    <form class="bg-gray-50 rounded-3xl p-4 md:p-8 space-y-4 md:space-y-6">
                        ...
                        <textarea 
                            ...
                            class="w-full px-4 md:px-6 py-3 md:py-4 rounded-2xl border border-gray-200 focus:border-blue-500 focus:outline-none resize-none"
                        ></textarea>
                        
                        <button type="submit" class="w-full bg-gradient-to-r from-green-500 to-emerald-500 text-white py-3 md:py-4 rounded-2xl font-semibold text-base md:text-lg">
