...
@section('content')
<!-- Hero Section -->
<section id="home" class="relative flex justify-center items-center overflow-hidden bg-white pb-16 md:pb-20 lg:pb-24">
    <!-- Background blur hijau & kuning -->
    <div class="absolute -top-20 -left-20 w-72 h-72 bg-green-300 rounded-full mix-blend-multiply filter blur-3xl opacity-40"></div>
    <div class="absolute top-40 -right-20 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-3xl opacity-40"></div>
    <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-96 h-96 bg-green-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></div>
...
<section class="py-16 md:py-20 lg:py-24 bg-white">
    <div class="container max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <!-- Produk Unggulan 1 -->
            <div class="section-reveal border bg-white/60 border border-neutral-200 rounded-3xl overflow-hidden transition-all duration-300 transform hover:-translate-y-2">
                <!-- Product Image -->
                <div class="h-48 bg-gradient-to-br from-red-200 to-red-300 flex items-center justify-center overflow-hidden">
                ...
                <div class="p-6">
                    <div class="flex items-center mb-4">
                        <div class="w-12 h-12 bg-red-100 rounded-xl flex items-center justify-center mr-4">
                            <i class="fas fa-cookie-bite text-red-600 text-xl"></i>
                        </div>
                        <div>
                            <div class="text-xs text-green-600 font-medium bg-green-100 px-2 py-1 rounded">Makanan</div>
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-4 line-clamp-2">Keripik Tempe Original</h3>
                    <p class="text-gray-600 text-sm mb-4 line-clamp-2">Keripik tempe renyah dengan bumbu rahasia khas Malang</p>
                    <div class="flex items-center justify-between">
                        <button class="text-green-600 w-full border border-green-700 mx-auto p-4 rounded-2xl text-sm font-semibold hover:text-green-700">Detail</button>
                    </div>
                </div>
            </div>
            ...
            <div class="section-reveal bg-white/60 border border-white/30 rounded-3xl shadow-lg overflow-hidden border-l-4 border-emerald-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                <!-- Product Image -->
                <div class="h-48 bg-gradient-to-br from-purple-200 to-purple-300 flex items-center justify-center overflow-hidden">
                ...
                <div class="p-6">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            <div class="text-xs text-emerald-600 font-medium bg-emerald-100 px-2 py-1 rounded">Fashion</div>
                            <div class="flex items-center gap-1 mt-1">
                                <span class="text-yellow-400 text-sm">⭐</span>
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-4 line-clamp-2">Tas Rajut Handmade</h3>
                    <p class="text-gray-600 text-sm mb-4 line-clamp-2">Tas rajut cantik buatan tangan dengan kualitas premium</p>
                    <div class="flex items-center justify-between">
                        <button class="text-green-600 w-full border border-green-700 mx-auto p-4 rounded-2xl text-sm font-semibold hover:text-green-700">Detail</button>
                    </div>
                </div>
            ...
            <div class="section-reveal bg-white/60 border border-white/30 rounded-3xl shadow-lg overflow-hidden border-l-4 border-teal-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                <!-- Product Image -->
                <div class="h-48 bg-gradient-to-br from-yellow-200 to-yellow-300 flex items-center justify-center overflow-hidden">
                ...
                <div class="p-6">
                    <div class="flex items-center mb-4">
                        ...
                        <div>
                            <div class="text-xs text-teal-600 font-medium bg-teal-100 px-2 py-1 rounded">Minuman</div>
                            <div class="flex items-center gap-1 mt-1">
                                <span class="text-yellow-400 text-sm">⭐</span>
                                <span class="text-sm font-medium text-gray-600">4.9</span>
                            </div>
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-4 line-clamp-2">Kopi Arabika Malang</h3>
                    <p class="text-gray-600 text-sm mb-4 line-clamp-2">Kopi premium dari perkebunan lokal dengan cita rasa khas</p>
                    <div class="flex items-center justify-between">
                        <button class="text-green-600 w-full border border-green-700 mx-auto p-4 rounded-2xl text-sm font-semibold hover:text-green-700">Detail</button>
                    </div>
                </div>
    ...
    <div class="container max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12">
        <div class="text-center mb-12 md:mb-16 lg:mb-20 section-reveal">
            ...
            <div class="flex flex-wrap justify-center gap-4 mb-8">
                <button id="filterNew" class="filter-btn bg-white/70 text-gray-700 border-2 border-gray-300 px-6 py-3 rounded-full font-semibold transition-all duration-300 hover:border-green-600 hover:text-green-600 active">
                    Produk Terbaru
                </button>
                <button id="filterFavorite" class="filter-btn bg-white/70 text-gray-700 border-2 border-gray-300 px-6 py-3 rounded-full font-semibold transition-all duration-300 hover:border-green-600 hover:text-green-600">
                    Produk Favorit
                </button>
            </div>
        </div>
            ...
            <div class="section-reveal group product-card" data-category="baru">
                <div class="bg-white/60 border border-white/30 rounded-2xl overflow-hidden transition-all duration-500 transform hover:-translate-y-2 hover:border-green-200 cursor-pointer shadow-lg">
                    ...
                    <div class="p-4">
                        ...
                        <h3 class="text-lg font-bold text-gray-800 mb-3 group-hover:text-green-600 transition-colors">Jamu Tradisional</h3>
                        <div class="flex items-center justify-between">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            <div class="section-reveal bg-white/60 border border-white/30 rounded-3xl shadow-lg overflow-hidden border-l-4 border-green-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-4">Workshop Digital Marketing UMKM</h3>
            ...
            <div class="section-reveal bg-white/60 border border-white/30 rounded-3xl shadow-lg overflow-hidden border-l-4 border-emerald-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-4">Pameran Produk UMKM</h3>
            ...
            <div class="section-reveal bg-white/60 border border-white/30 rounded-3xl shadow-lg overflow-hidden border-l-4 border-teal-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-4">Seminar Keuangan UMKM</h3>
            ...
            <div class="section-reveal bg-white/60 border border-white/30 rounded-3xl shadow-lg overflow-hidden border-l-4 border-orange-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-4">Kompetisi Inovasi UMKM</h3>
        ...
        <div class="grid lg:grid-cols-2 xl:grid-cols-4 gap-6 mb-12">
            ...
            <div class="section-reveal group bg-white/60 border border-white/30 rounded-3xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-4 line-clamp-2 group-hover:text-green-600 transition-colors">
...
<!-- Join UMKM Section -->
<section class="py-16 md:py-20 lg:py-24 bg-gradient-to-br from-green-400 via-emerald-500 to-teal-600 relative overflow-hidden">
    ...
    <div class="container max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12 relative z-10">
        <div class="text-center text-white section-reveal">
            ...
            <button class="bg-white text-green-600 px-12 py-4 rounded-full font-bold text-xl hover:bg-green-50 transition-all transform hover:scale-105">
        ...
        searchInput.addEventListener('input', function() {
            ...
            if (value.length > 2) {
                ...
                if (filtered.length > 0) {
                    ...
                    suggestionBox.className = 'absolute top-full left-0 right-0 bg-white border border-gray-200 rounded-lg shadow-lg z-50 mt-1';
