    ...
    <div class="w-full max-w-2xl mx-auto relative z-10">
        <div class="glass rounded-3xl p-8 md:p-10">
            ...
            <form action="" method="POST" class="space-y-6">
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input id="nik" name="nik" type="text" required
                                class="input-field" placeholder="Masukkan NIK Anda">
                        </div>
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Nama Lengkap*</label>
                            <input id="name" name="name" type="text" required
                                class="input-field" placeholder="Nama sesuai KTP">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select id="gender" name="gender" class="input-field select-field">
                ...
                <!-- Address Section -->
                <div class="space-y-4">
                    <h3 class="text-lg font-semibold text-gray-800">Alamat Tempat Tinggal</h3>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="province" class="block text-sm font-medium text-gray-700 mb-1">Provinsi</label>
                            <select id="province" name="province" class="input-field select-field">
                        ...
                        <div>
                            ...
                            <select id="city" name="city" class="input-field select-field">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select id="district" name="district" class="input-field select-field">
                        ...
                        <div>
                            ...
                            <select id="subdistrict" name="subdistrict" class="input-field select-field">
                    ...
                    <div>
                        ...
                        <textarea id="address" name="address" rows="2" required
                            class="input-field" placeholder="Jl. Contoh No. 123"></textarea>
                    </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <label for="terms" class="text-sm text-gray-700">
                            Saya menyetujui <a href="#" class="text-green-600 hover:underline">Syarat & Ketentuan</a> dan <a href="#" class="text-green-600 hover:underline">Kebijakan Privasi</a>
                        </label>
                    </div>
                </div>
