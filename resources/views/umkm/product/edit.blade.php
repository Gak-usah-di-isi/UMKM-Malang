    ...
    <main class="flex-1 p-6">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600">Perbarui informasi produk dan foto produk.</p>
            </div>

            <form action="{{ route('umkm.products.update', $product->slug) }}" method="POST" enctype="multipart/form-data"
                class="space-y-8">
                @csrf
                @method('PUT')
                ...
                @if ($product->photos->count() > 0)
                    <div class="bg-white shadow-lg rounded-xl p-6 border border-gray-100">
                        <h2 class="text-xl font-semibold text-gray-800 mb-4">Foto Saat Ini</h2>
                                    ...
                                    <div
                                        ...
                                        <label class="opacity-0 group-hover:opacity-100 transition-opacity">
                                            <input type="checkbox" name="remove_photos[]" value="{{ $photo->id }}"
                                                class="sr-only peer">
                                            <div
                                                class="peer-checked:bg-red-500 bg-white bg-opacity-80 text-red-500 peer-checked:text-white p-2 rounded-full cursor-pointer hover:bg-red-500 hover:text-white transition-colors">
                        ...
                        <p class="text-sm text-gray-500">Centang foto yang ingin dihapus</p>
                    </div>
                @endif

                <div class="bg-white shadow-lg rounded-xl p-6 border border-gray-100">
                    <h2 class="text-xl font-semibold text-gray-800 mb-4">Tambah Foto Baru</h2>
                    ...
                    <label for="photo-input" class="block cursor-pointer">
                        <div
                            ...
                            <div class="text-center">
                                ...
                                <div class="mt-6">
                                    <p class="text-lg font-medium text-gray-900">Klik di mana saja atau drag & drop foto di
                                        sini</p>
                    ...
                    <div id="photo-preview-container" class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4"></div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="6"
                                ...
                                placeholder="Ceritakan detail produk, keunggulan, bahan, cara penggunaan, dll...">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="url" name="buy_link" value="{{ old('buy_link', $product->buy_link) }}"
        ...
        function updatePreview() {
            ...
            selectedFiles.forEach((file, index) => {
                ...
                reader.onload = function(e) {
                    ...
                    removeBtn.classList.add('absolute', 'top-2', 'right-2', 'bg-red-500', 'text-white',
                    ...
                    overlay.classList.add('absolute', 'inset-0', 'bg-black', 'bg-opacity-0',
            ...
            if (selectedFiles.length > 0) {
                ...
                addMoreBtn.classList.add('aspect-square', 'border-2', 'border-dashed', 'border-gray-300', 'rounded-lg',
                    'flex', 'items-center', 'justify-center', 'cursor-pointer', 'hover:border-blue-400',
                    'transition-colors', 'hover:bg-blue-50');
                addMoreBtn.innerHTML =
                    `<div class="text-center"><svg class="w-8 h-8 text-gray-400 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg><p class="text-xs text-gray-500">Tambah Foto</p></div>`;
