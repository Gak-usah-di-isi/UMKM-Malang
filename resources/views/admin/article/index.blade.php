...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Kelola konten artikel Anda</p>
        </div>
    ...
    <div class="bg-white shadow-sm rounded-lg p-6 mb-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                ...
                <input type="text" name="q" id="search" value="{{ request('q') }}" placeholder="Judul artikel..."
            ...
            <div class="flex items-end">
                <button type="submit" class="w-full bg-gray-800 text-white px-4 py-2 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                    Terapkan Filter
                </button>
            </div>
        </form>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 mr-4">
                                    ...
                                    <img class="h-10 w-10 rounded-md object-cover" src="{{ asset('storage/' . $article->thumbnail) }}" alt="">
                                    @else
