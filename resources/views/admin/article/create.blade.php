                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                    ...
                    <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data" id="articleForm">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('title') @enderror"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50 @error('slug') @enderror"
                        ...
                        <div class="mb-6">
                            ...
                            <select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('article_category_id') @enderror"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <span class="text-sm text-gray-500" id="file-name">Belum ada file dipilih</span>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="content" id="editor"
                                A class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('content') @enderror"
                                rows="20" required>{{ old('content') }}</textarea>
                            @error('content')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                    ...
                    <div class="border rounded-lg p-4 bg-gray-50">
                        ...
                        <div class="text-green-600 text-sm mt-1" id="preview-url">
                            [https://example.com/artikel/slug-artikel](https://example.com/artikel/slug-artikel)
                        </div>
                        <div class="text-gray-600 text-sm mt-2" id="preview-description">
                            Konten artikel akan muncul di sini.
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        ClassicEditor
            ...
            .then(editor => {
                // Attach a listener to the editor's data change event
                editor.model.document.on('change:data', () => {
                    // Update the Google preview description with a truncated version of the content
